...
func benchmarkFF3_1(
	b *testing.B, f func(*FF3_1, string, []byte) (string, error),
...
func BenchmarkFF3_1Encrypt128(b *testing.B) {
	benchmarkFF3_1(b, (*FF3_1).Encrypt,
		[]byte{
			0xef, 0x43, 0x59, 0xd8, 0xd5, 0x80, 0xaa, 0x4f,
			0x7f, 0x03, 0x6d, 0x6f, 0x04, 0xfc, 0x6a, 0x94,
		},
...
func BenchmarkFF3_1Encrypt192(b *testing.B) {
	benchmarkFF3_1(b, (*FF3_1).Encrypt,
		[]byte{
			0xef, 0x43, 0x59, 0xd8, 0xd5, 0x80, 0xaa, 0x4f,
			0x7f, 0x03, 0x6d, 0x6f, 0x04, 0xfc, 0x6a, 0x94,
...
func BenchmarkFF3_1Encrypt256(b *testing.B) {
	benchmarkFF3_1(b, (*FF3_1).Encrypt,
		[]byte{
			0xef, 0x43, 0x59, 0xd8, 0xd5, 0x80, 0xaa, 0x4f,
			0x7f, 0x03, 0x6d, 0x6f, 0x04, 0xfc, 0x6a, 0x94,
...
func BenchmarkFF3_1Decrypt128(b *testing.B) {
	benchmarkFF3_1(b, (*FF3_1).Decrypt,
		[]byte{
			0xef, 0x43, 0x59, 0xd8, 0xd5, 0x80, 0xaa, 0x4f,
			0x7f, 0x03, 0x6d, 0x6f, 0x04, 0xfc, 0x6a, 0x94,
		},
...
func BenchmarkFF3_1Decrypt192(b *testing.B) {
	benchmarkFF3_1(b, (*FF3_1).Decrypt,
		[]byte{
			0xef, 0x43, 0x59, 0xd8, 0xd5, 0x80, 0xaa, 0x4f,
			0x7f, 0x03, 0x6d, 0x6f, 0x04, 0xfc, 0x6a, 0x94,
...
func BenchmarkFF3_1Decrypt256(b *testing.B) {
	benchmarkFF3_1(b, (*FF3_1).Decrypt,
		[]byte{
			0xef, 0x43, 0x59, 0xd8, 0xd5, 0x80, 0xaa, 0x4f,
			0x7f, 0x03, 0x6d, 0x6f, 0x04, 0xfc, 0x6a, 0x94,
